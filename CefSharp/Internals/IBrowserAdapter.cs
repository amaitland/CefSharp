...
namespace CefSharp.Internals
{
    ...
    public interface IBrowserAdapter
    {
        ...
        IBrowser GetBrowser();
        bool OnProcessMessageReceived(IBrowser browser, IProcessMessage message);
        Task<JavascriptResponse> EvaluateScriptAsync(IBrowser browser, long frameId, string script, TimeSpan? timeout);
    }
}
