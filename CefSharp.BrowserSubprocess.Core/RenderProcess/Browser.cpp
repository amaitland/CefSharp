...
namespace CefSharp
{
    namespace RenderProcess
    {
        ...
        CefSharp::RenderProcess::IFrame^ Browser::MainFrame::get()
        {
        ...
        ///
        /*--cef()--*/
        CefSharp::RenderProcess::IFrame^ Browser::FocusedFrame::get()
        {
        ...
        CefSharp::RenderProcess::IFrame^ Browser::GetFrame(Int64 identifier)
        {
        ...
        CefSharp::RenderProcess::IFrame^ Browser::GetFrame(String^ name)
        {
