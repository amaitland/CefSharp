...
namespace CefSharp
{
    ...
    public static class Cef
    {
        ...
        {
            return Core.Cef.Initialize(cefSettings.settings);
        }
        ...
        {
            return Core.Cef.Initialize(cefSettings.settings, performDependencyCheck);
        }
        ...
        {
            return Core.Cef.Initialize(cefSettings.settings, performDependencyCheck, browserProcessHandler);
        }
        ...
        {
            return Core.Cef.Initialize(cefSettings.settings, performDependencyCheck, cefApp);
        }
    ...
    /// <inheritdoc/>
    public class ManagedCefBrowserAdapter
    {
        public static IBrowserAdapter Create(CefSharp.Internals.IWebBrowserInternal webBrowserInternal, bool offScreenRendering)
        {
    ...
    public class UrlRequest : IUrlRequest
    {
        ...
        {
            urlrequest = new Core.UrlRequest(request, urlRequestClient);
        }

        public UrlRequest(IRequest request, IUrlRequestClient urlRequestClient, IRequestContext requestContext)
        {
            urlrequest = new Core.UrlRequest(request, urlRequestClient, requestContext);
        }
