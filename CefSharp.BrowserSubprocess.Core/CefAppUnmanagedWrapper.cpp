...
namespace CefSharp
{
    ...
    void CefAppUnmanagedWrapper::OnWebKitInitialized()
    {
        ...
        //CefRegisterExtension("cefsharp/registerBoundObject", kRegisterBoundObjectScript, NULL);
        //CefRegisterExtension("cefsharp/registerBoundObject", kRegisterBoundObjectScript, new RegisterBoundObjectHandler());
