...
{
    /// <summary>
    /// ChromiumWidgetHandleFinder is a helper class used to find the child Hwnd for the
    /// browser instance
    /// </summary>
    public static class ChromiumWidgetHandleFinder
    {
        /// <summary>
        ...
        public static bool TryFindHandle(ChromiumWebBrowser chromiumWebBrowser, out IntPtr chromerRenderWidgetHostHandle)
        {
