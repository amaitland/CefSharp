...
namespace CefSharp
{
    public interface ILifeSpanHandler
    {
        ...
        /// <param name="targetFrameName">The initial title of the new popup.</param>
        ...
        /// source browser.
        /// </remarks>
        bool OnBeforePopup(IWebBrowser browserControl, IBrowser browser, IFrame frame, string targetUrl, string targetFrameName, ref int x, ref int y, ref int width, ref int height, ref bool noJavascriptAccess, out IWebBrowser newBrowser);
